<p align="center">
  <img src="screenshot.png" alt="Recroogle initial state" width="700">
</p>
...
**Recroogle** (a pun on *Recruit* + *Google* — the "u" replaced with the "oo" sound) is a playful search engine based on Google that always returns the same result — me. No matter what you search for, the answer is always the same: [**@eurafa**](https://github.com/eurafa).
